...
def create_venv(project_name):
    ...
    process = subprocess.Popen('cd {} && python -m venv venv'.format(project_name), shell=True, stdout=subprocess.PIPE)
